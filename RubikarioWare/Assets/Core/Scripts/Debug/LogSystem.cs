...
namespace Game.Core
{
    public class LogSystem : MonoBehaviour
    {
        ...
        [SerializeField, BoxGroup("References")] private VerbLoader verbLoader = default;
        [SerializeField, BoxGroup("References")] private GameState gameState = default;
		...
		private void Start()
		{
			...
			verbLoader = FindObjectOfType<VerbLoader>();
